...
from .mod_mapvector_gui import Ui_MapVectorDataGui          # >>> IMPORT STATEMENT


# --- MAIN GUI FUNCTION ---
class MapVectorDataLaunch(QtWidgets.QDialog):         # >>> MODULE NAME
    # MODULE'S BASIC METADATA
    type = "master"
    catname = "Spatial Representation"
    catorder = 8
    longname = "Map Vector Data"
    ...
    def __init__(self, main, simulation, datalibrary, simlog, mode, parent=None):
        ...
        self.ui = Ui_MapVectorDataGui()               # >>> INSTANTIATE GUI ELEMENT
