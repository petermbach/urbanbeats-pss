...
from .mod_waterdemand_gui import Ui_WaterDemandGui          # >>> IMPORT STATEMENT


# --- MAIN GUI FUNCTION ---
class WaterDemandLaunch(QtWidgets.QDialog):         # >>> MODULE NAME
    # MODULE'S BASIC METADATA                       # >>> MODULE METADATA
    type = "master"
    ...
    def __init__(self, main, simulation, datalibrary, simlog, mode, parent=None):
        ...
        self.ui = Ui_WaterDemandGui()               # >>> INSTANTIATE GUI ELEMENT
