...
class Ui_MetadataDialog(object):
    def setupUi(self, MetadataDialog):
        ...
        self.gridLayout.addWidget(self.attributes_list, 2, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.module_list, 2, 0, 1, 1)
    ...
    def retranslateUi(self, MetadataDialog):
        ...
        self.attributes_list.headerItem().setText(0, _translate("MetadataDialog", "Asset Type"))
        self.attributes_list.headerItem().setText(1, _translate("MetadataDialog", "Attribute Name"))
        self.attributes_list.headerItem().setText(2, _translate("MetadataDialog", "Details"))
        self.module_list.headerItem().setText(1, _translate("MetadataDialog", "Value"))
