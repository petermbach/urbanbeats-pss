...
class Ui_CalibrationViewer(object):
    def setupUi(self, CalibrationViewer):
        ...
        self.assetcol_title = QtWidgets.QLabel(self.navigation_widget)
        self.assetcol_title.setObjectName("assetcol_title")
        self.verticalLayout.addWidget(self.assetcol_title)
        self.assetcol_combo = QtWidgets.QComboBox(self.navigation_widget)
        self.assetcol_combo.setMinimumSize(QtCore.QSize(0, 0))
        ...
        self.verticalLayout.addWidget(self.assetcol_combo)
    ...
    def retranslateUi(self, CalibrationViewer):
        ...
        self.assetcol_title.setText(_translate("CalibrationViewer", "<html><head/><body><p><span style=\" font-weight:600; font-style:italic;\">Asset Collection</span></p></body></html>"))
        self.assetcol_combo.setItemText(0, _translate("CalibrationViewer", "(select asset collection)"))
        ...
        self.set_aggregation_combo.setItemText(5, _translate("CalibrationViewer", "SimGrid by SimGrid"))
