...
class Ui_CalibrationViewer(object):
    def setupUi(self, CalibrationViewer):
        ...
        self.assetcol_title = QtWidgets.QLabel(self.calibrationSettings)
        self.assetcol_title.setObjectName("assetcol_title")
        self.verticalLayout_3.addWidget(self.assetcol_title)
        self.assetcol_combo = QtWidgets.QComboBox(self.calibrationSettings)
        ...
        self.verticalLayout_3.addWidget(self.assetcol_combo)
