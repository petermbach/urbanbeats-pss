...
class Ui_CalibrationViewer(object):
    ...
    def retranslateUi(self, CalibrationViewer):
        ...
        self.set_param_lbl.setText(_translate("CalibrationViewer", "Select Parameter and Type of Calibration:"))
        self.set_param_combo.setItemText(0, _translate("CalibrationViewer", "<select parameter to calibrate>"))
        self.set_param_combo.setItemText(1, _translate("CalibrationViewer", "Impervious Area"))
        self.set_param_combo.setItemText(2, _translate("CalibrationViewer", "Residential Allotment Count"))
        self.set_param_combo.setItemText(3, _translate("CalibrationViewer", "Residential House Count"))
        self.set_param_combo.setItemText(4, _translate("CalibrationViewer", "Total Residential Roof Area"))
        self.set_param_combo.setItemText(5, _translate("CalibrationViewer", "Water Demand"))
        self.set_typetotal_radio.setText(_translate("CalibrationViewer", "Total Value"))
        self.set_typeblock_radio.setText(_translate("CalibrationViewer", "Block-by-block"))
        ...
        self.set_totvalue_lbl.setText(_translate("CalibrationViewer", "Enter Total Value (units [%]) :"))
        self.set_gen_lbl.setText(_translate("CalibrationViewer", "Create/Select Calibration Data Set:"))
        self.set_gen_combo.setItemText(0, _translate("CalibrationViewer", "Manual Data Entry..."))
        self.set_gen_combo.setItemText(1, _translate("CalibrationViewer", "Load Existing Data Set..."))
        self.set_gen_combo.setItemText(2, _translate("CalibrationViewer", "MW MUSIC Guide"))
        self.set_gen_combo.setItemText(3, _translate("CalibrationViewer", "Sponge Cities Guidelines"))
        self.set_data_table.setSortingEnabled(False)
        item = self.set_data_table.horizontalHeaderItem(0)
        item.setText(_translate("CalibrationViewer", "BlockID"))
        item = self.set_data_table.horizontalHeaderItem(1)
        item.setText(_translate("CalibrationViewer", "Observed"))
        self.set_data_export.setText(_translate("CalibrationViewer", "Export Data..."))
        self.set_data_reset.setText(_translate("CalibrationViewer", "Reset Table"))
        ...
        self.out_export.setText(_translate("CalibrationViewer", "Export Results..."))
