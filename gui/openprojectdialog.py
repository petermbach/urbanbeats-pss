...
class Ui_OpenProjectDialog(object):
    def setupUi(self, OpenProjectDialog):
        ...
        self.clear_button = QtWidgets.QPushButton(self.path_widget_3)
        self.clear_button.setText("")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icons/file-warning-icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, OpenProjectDialog):
        ...
        self.clear_button.setToolTip(_translate("OpenProjectDialog", "<html><head/><body><p>Clear Recent</p></body></html>"))
