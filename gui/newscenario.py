...
class Ui_NewScenarioDialog(object):
    def setupUi(self, NewScenarioDialog):
        ...
        self.gridLayout_6.setContentsMargins(14, 14, 14, 14)
        ...
        self.gridLayout_7.setContentsMargins(14, 14, 14, 14)
        ...
        self.regulation = QtWidgets.QCheckBox(self.scrollAreaWidgetContents)
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(":/icons/Actions-view-pim-tasks-icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.regulation.setIcon(icon12)
        self.regulation.setObjectName("regulation")
        self.gridLayout_5.addWidget(self.regulation, 6, 1, 1, 1)
        self.infrastructure = QtWidgets.QCheckBox(self.scrollAreaWidgetContents)
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(":/icons/Bench-icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.infrastructure.setIcon(icon13)
        self.infrastructure.setObjectName("infrastructure")
        self.gridLayout_5.addWidget(self.infrastructure, 7, 0, 1, 1)
        self.performance = QtWidgets.QCheckBox(self.scrollAreaWidgetContents)
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap(":/icons/Bar-chart-icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.performance.setIcon(icon14)
        self.performance.setObjectName("performance")
        self.gridLayout_5.addWidget(self.performance, 9, 0, 1, 1)
        self.decisionanalysis = QtWidgets.QCheckBox(self.scrollAreaWidgetContents)
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap(":/icons/Data-Flow-Chart-icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.decisionanalysis.setIcon(icon15)
        self.decisionanalysis.setObjectName("decisionanalysis")
        self.gridLayout_5.addWidget(self.decisionanalysis, 10, 0, 1, 1)
        self.impact = QtWidgets.QCheckBox(self.scrollAreaWidgetContents)
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap(":/icons/Market-Analysis-icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.impact.setIcon(icon16)
        self.impact.setObjectName("impact")
        self.gridLayout_5.addWidget(self.impact, 9, 1, 1, 1)
        ...
        self.setup_widget.addTab(self.module_tab, icon17, "")
        ...
        self.verticalLayout_4.setContentsMargins(14, 14, 14, 14)
        ...
        icon18 = QtGui.QIcon()
        icon18.addPixmap(QtGui.QPixmap(":/icons/Misc-Database-3-icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.setup_widget.addTab(self.data_tab, icon18, "")
        ...
        icon19 = QtGui.QIcon()
        icon19.addPixmap(QtGui.QPixmap(":/icons/export-icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.setup_widget.addTab(self.output_tab, icon19, "")
    ...
    def retranslateUi(self, NewScenarioDialog):
        ...
        self.descr_lbl3.setText(_translate("NewScenarioDialog", "<html><head/><body><p><span style=\" font-weight:600;\">Planning</span></p></body></html>"))
        ...
        self.descr_lbl4.setText(_translate("NewScenarioDialog", "<html><head/><body><p><span style=\" font-weight:600;\">Environment</span></p></body></html>"))
        ...
        self.spatialmapping.setText(_translate("NewScenarioDialog", "Spatial Mapping"))
        self.regulation.setText(_translate("NewScenarioDialog", "Regulation"))
        self.infrastructure.setText(_translate("NewScenarioDialog", "Infrastructure"))
        self.performance.setText(_translate("NewScenarioDialog", "Performance"))
        self.decisionanalysis.setText(_translate("NewScenarioDialog", "Decision Analysis"))
        self.impact.setText(_translate("NewScenarioDialog", "Impact"))
