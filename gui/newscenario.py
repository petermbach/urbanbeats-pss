...
class Ui_NewScenarioDialog(object):
    def setupUi(self, NewScenarioDialog):
        ...
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap(":/icons/Industry-Water-icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap(":/icons/Weather-Floods-icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap(":/icons/Bench-icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
