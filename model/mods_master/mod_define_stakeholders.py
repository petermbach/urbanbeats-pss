r"""
@file   mod_define_stakeholders.py
...
class DefineStakeholders(UBModule):
    """ Defines and consolidates information on all stakeholders identified in the biophysical modelling. Allows import
    of new stakeholders, georeferencing and addition of useful qualitative data. """

    # MODULE'S BASIC METADATA
    type = "master"
    catname = "Social Analysis"
    catorder = 0
    longname = "Define Stakeholders"
    ...
    def initialize_runstate(self):
        ...
        self.meta.add_attribute("mod_define_stakeholders", 1)
    ...
    def run_module(self):
        ...
        self.notify("Consolidating and Setting up Project Stakeholder Collection")
        self.notify("--- === ---")
        ...
        self.notify("Stakeholder data consolidated and ready for analysis")
