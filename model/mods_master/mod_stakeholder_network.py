r"""
@file   mod_stakeholder_network.py
...
class StakeholderNetworkAnalysis(UBModule):
    """ Analyses the current asset collection stakeholder data in a number of different ways, drawing key network links
    and relationships, producing a large output of social network and social-ecological information."""

    # MODULE'S BASIC METADATA
    type = "master"
    catname = "Social Analysis"
    catorder = 1
    longname = "Stakeholder Network Analysis"
    icon = ":/icons/stakeholder_net.png"
    ...
    def initialize_runstate(self):
        ...
        self.meta.add_attribute("mod_stakeholder_network", 1)
    ...
    def run_module(self):
        ...
        self.notify("Analyzing Stakeholder Network")
        self.notify("--- === ---")
