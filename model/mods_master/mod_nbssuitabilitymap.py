...
class NbSSuitabilityMapping(UBModule):
    ...
    catorder = 1
    longname = "NbS Suitability Mapping"
    icon = ":/icons/nbs_suitabilitymap.png"
    ...
    def run_module(self):
        ...
        self.notify("Performing suitability assessment of Nature-based solutions")
        self.notify("--- === ---")
