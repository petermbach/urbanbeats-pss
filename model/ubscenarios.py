...
import gc
import time
import xml.etree.ElementTree as xmlElementTree  # XML parsing for loading scenario files
...
import model.modules.md_impactassess as md_impactasess
...
import model.modules.md_infrastructure as md_techplacement
import model.modules.md_urbandev as md_urbandev
import model.modules.md_urbplanbb as md_urbplanbb
import model.ublibs.ubspatial as ubspatial
import model.ubexports.blocks as xblocks
import model.ubexports.flowpaths as xflowpaths
import model.ubexports.openspace as xopenspace
import model.ubexports.patches as xpatches
import model.ubexports.regions as xregions
import model.ubexports.urban as xurbanmodel
...
class UrbanBeatsScenario(threading.Thread):
    ...
    def setup_scenario_from_xml(self, filename):
        ...
        f = xmlElementTree.parse(self.projectpath + "/scenarios/" + filename)
        root = f.getroot()
