...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setTabOrder(self.DataView_web, self.ModuleDock_spatialsetup)
        MainWindow.setTabOrder(self.ModuleDock_spatialsetup, self.ModuleDock_climatesetup)
        MainWindow.setTabOrder(self.ModuleDock_climatesetup, self.ModuleDock_urbandev)
        MainWindow.setTabOrder(self.ModuleDock_urbandev, self.ModuleDock_urbanplan)
        MainWindow.setTabOrder(self.ModuleDock_urbanplan, self.ModuleDock_socioeconomic)
        MainWindow.setTabOrder(self.ModuleDock_socioeconomic, self.ModuleDock_spatialmap)
        MainWindow.setTabOrder(self.ModuleDock_spatialmap, self.ModuleDock_regulation)
        MainWindow.setTabOrder(self.ModuleDock_regulation, self.ModuleDock_infrastructure)
        MainWindow.setTabOrder(self.ModuleDock_infrastructure, self.ModuleDock_performance)
        MainWindow.setTabOrder(self.ModuleDock_performance, self.ModuleDock_impact)
        MainWindow.setTabOrder(self.ModuleDock_impact, self.ModuleDock_decisionanalysis)
        MainWindow.setTabOrder(self.ModuleDock_decisionanalysis, self.SimDock_run)
