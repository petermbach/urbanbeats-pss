...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.OutputConsole = QtWidgets.QPlainTextEdit(self.Progress_Widget)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.DataDock_View.topLevelItem(0).child(3).setText(0, _translate("MainWindow", "Soil Classification"))
        self.DataDock_View.topLevelItem(0).child(3).child(0).setText(0, _translate("MainWindow", "<no data>"))
        self.DataDock_View.topLevelItem(0).child(4).setText(0, _translate("MainWindow", "Built Infrastructure"))
        self.DataDock_View.topLevelItem(0).child(4).child(0).setText(0, _translate("MainWindow", "<no data>"))
        self.DataDock_View.topLevelItem(0).child(5).setText(0, _translate("MainWindow", "Overlays"))
        self.DataDock_View.topLevelItem(0).child(5).child(0).setText(0, _translate("MainWindow", "<no data>"))
        self.DataDock_View.topLevelItem(0).child(6).setText(0, _translate("MainWindow", "Locality Maps"))
