...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.textEdit = QtWidgets.QTextEdit(self.Project_tab)
        ...
        item_1.setCheckState(0, QtCore.Qt.Checked)
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(":/icons/Transport-Road-Worker-icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon37 = QtGui.QIcon()
        icon37.addPixmap(QtGui.QPixmap(":/icons/Info-icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionAbout.setIcon(icon37)
        self.actionAbout.setObjectName("actionAbout")
        self.actionLike_on_Facebook = QtWidgets.QAction(MainWindow)
        icon38 = QtGui.QIcon()
        icon38.addPixmap(QtGui.QPixmap(":/icons/social-facebook-box-blue-icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionLike_on_Facebook.setIcon(icon38)
        self.actionLike_on_Facebook.setObjectName("actionLike_on_Facebook")
        self.actionShare_on_Twiter = QtWidgets.QAction(MainWindow)
        icon39 = QtGui.QIcon()
        icon39.addPixmap(QtGui.QPixmap(":/icons/twitter-icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionShare_on_Twiter.setIcon(icon39)
        ...
        icon40 = QtGui.QIcon()
        icon40.addPixmap(QtGui.QPixmap(":/icons/Actions-office-chart-area-icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionModel_Calibration_Viewer.setIcon(icon40)
        ...
        icon41 = QtGui.QIcon()
        icon41.addPixmap(QtGui.QPixmap(":/icons/Distributor-report-icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionView_Project_Description.setIcon(icon41)
        ...
        icon42 = QtGui.QIcon()
        icon42.addPixmap(QtGui.QPixmap(":/icons/Clipboard-icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionView_Full_Project_Log.setIcon(icon42)
        ...
        icon43 = QtGui.QIcon()
        icon43.addPixmap(QtGui.QPixmap(":/icons/debug-png-image-88477.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionSubmit_a_Bug_Report.setIcon(icon43)
        ...
        icon44 = QtGui.QIcon()
        icon44.addPixmap(QtGui.QPixmap(":/icons/House-icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionResidential.setIcon(icon44)
        self.actionResidential.setObjectName("actionResidential")
        self.actionNon_Residentail = QtWidgets.QAction(MainWindow)
        icon45 = QtGui.QIcon()
        icon45.addPixmap(QtGui.QPixmap(":/icons/Building-icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionNon_Residentail.setIcon(icon45)
        ...
        icon46 = QtGui.QIcon()
        icon46.addPixmap(QtGui.QPixmap(":/icons/Car-icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionTransport.setIcon(icon46)
        self.actionTransport.setObjectName("actionTransport")
        self.actionOpen_Spaces = QtWidgets.QAction(MainWindow)
        icon47 = QtGui.QIcon()
        icon47.addPixmap(QtGui.QPixmap(":/icons/Tree-icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionOpen_Spaces.setIcon(icon47)
        self.actionOpen_Spaces.setObjectName("actionOpen_Spaces")
        self.actionMiscellaneous = QtWidgets.QAction(MainWindow)
        icon48 = QtGui.QIcon()
        icon48.addPixmap(QtGui.QPixmap(":/icons/gps-2845363_960_720.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionMiscellaneous.setIcon(icon48)
        ...
        MainWindow.setTabOrder(self.DataDock_View, self.addData)
        ...
        MainWindow.setTabOrder(self.expcolData, self.ScenarioDock_Combo)
        MainWindow.setTabOrder(self.ScenarioDock_Combo, self.ScenarioDock_View)
        MainWindow.setTabOrder(self.ScenarioDock_View, self.newScenario)
        ...
        MainWindow.setTabOrder(self.DataView_web, self.SimDock_run)
        MainWindow.setTabOrder(self.SimDock_run, self.SimDock_mapoptions)
        MainWindow.setTabOrder(self.SimDock_mapoptions, self.SimDock_projectfolder)
        MainWindow.setTabOrder(self.SimDock_projectfolder, self.SimDock_resultsview)
        MainWindow.setTabOrder(self.SimDock_resultsview, self.SimDock_report)
        MainWindow.setTabOrder(self.SimDock_report, self.DataSummary_check)
